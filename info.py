...
API_ID = int(environ.get('API_ID', '29219170'))
API_HASH = environ.get('API_HASH', '12d6648ede66e1ef31d9c455317ee09d')
BOT_TOKEN = environ.get('BOT_TOKEN', "5837036557:AAE2bB5o_uMXrmJaXij997Kz7YQsE1BgYb0")

# Bot settings
CACHE_TIME = int(environ.get('CACHE_TIME', 300))
USE_CAPTION_FILTER = bool(environ.get('USE_CAPTION_FILTER', True))

PICS = (environ.get('PICS', 'https://telegra.ph/file/08443f8c77349a5e02ca5.jpg')).split()
...
NEWGRP = environ.get("NEWGRP", "https://telegra.ph/file/08443f8c77349a5e02ca5.jpg")
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://Sohanrazz:Sohanrazz@cluster0.nb06nv2.mongodb.net/?retryWrites=true&w=majority")
DATABASE_NAME = environ.get('DATABASE_NAME', "v5Bot")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'Telegram_files')

# Channel Button Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/Movies_searcher2')
CHNL_LNK = environ.get('CHNL_LNK', 'netflix_hindi_movies_4k2')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/+FVhiCrwL2oJhMGFl')
MSG_ALRT = environ.get('MSG_ALRT', 'Share and Support Us')

# Custom Chats
SUPPORT_GROUP = int(environ.get('SUPPORT_GROUP', -100885743510))
FILE_CHANNEL = int(environ.get('FILE_CHANNEL', -1001679808420))
FILE_CHANNEL_LINK = environ.get('FILE_CHANNEL_LINK', 'https://t.me/+zSwVlMdqWNo2YjVl')
HOW_DWLD_LINK = environ.get('HOW_DWLD_LINK', 'https://t.me/')

# Log Channels
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', -918566682))
RQST_LOG_CHANNEL = int(environ.get('RQST_LOG_CHANNEL', -918566682))
...
URL_SHORTNER_WEBSITE_API = environ.get('URL_SHORTNER_WEBSITE_API', '44a730ce9cf9c76c108f712d84d00e7f1460eaa1')
