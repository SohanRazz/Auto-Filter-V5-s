...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        buttons = [[
            ...
            InlineKeyboardButton('ʙᴀᴄᴋᴜᴘ ᴄʜᴀɴɴᴇʟ', url="https://t.me/requestluciferdownload")
        ],[
        ...
        await query.message.edit_text(
            ...
            cnlbtn = [[
                      InlineKeyboardButton('ᴄʜᴀɴɴᴇʟ', url='https://t.me/netflix_hindi_movies_4k')
                     ], [
                      InlineKeyboardButton('sᴜᴘᴘᴏʀᴛ', url='https://t.me/requestluciferdownload'),
                      InlineKeyboardButton('ᴜᴘᴅᴀᴛᴇs', url='https://t.me/Mdisk_search_netflix_bot_updates')
                     ], [
                      InlineKeyboardButton("⟸ Bᴀᴄᴋ", callback_data="start")
                     ]]
